...
import io.github.nicholasphair.arxiv.auth.Authentication;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  private String basePath = "http://export.arxiv.org";
  ...
  public boolean isXMLMime(String mime) {
    String xmlMime = "(?i)^(application/xml|[^;/ \t]+/[^;/ \t]+[+]xml)[ \t]*(;.*)?$";
  ...
  public <T> T deserialize(HttpResponse response, TypeReference<T> valueType) throws ApiException, IOException {
    ...
    if (mimeType == null || isJsonMime(mimeType) || isXMLMime(mimeType)) {
